...
;------------------------------------------
;int sslen(String message, String reg)
;eax message; ebx reg
;return  x_len
...
sinput:
    ...
    mov     edx, ebx        ;move len to edx
    mov     ecx, eax        ;move the store address to ecx
...
;------------------------------------------
;int count(String input, String reg)
;11111 11111, ' '
;ret = 5 
count:
    call    sslen
